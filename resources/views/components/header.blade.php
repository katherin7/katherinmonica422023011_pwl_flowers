            ...
            <div class="row">
                <div class="col-lg-12 d-none d-md-block">
                    <div class="top-logo-area">
                        ...
                        <a href="{{route('home')}}"><img src="{{asset('https://i.pinimg.com/550x/c2/05/9b/c2059bcbc3f08430fadb1c1bf8279642.jpg')}}" alt="logo" style="width:25%"></a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row align-items-center">
                ...
                <div class="col-lg-3 col-lg-3 col-6">
                    <div class="header-right-items content_hidden d-none d-md-block"> 
                        <span class="phone-number font-lg-p" title="Call us for fast delivery"> 
                            <a href="#cfd"><i class="icon-telephone"></i>&nbsp;&nbsp;<small class="text-color-primary"><b>+(62) 8998521829</b></small></a>
                        </span>
                    </div>   
                    <div class="logo_hidden text-start">
                        <a href="{{route('home')}}"><img src="{{asset('https://i.pinimg.com/550x/c2/05/9b/c2059bcbc3f08430fadb1c1bf8279642.jpg')}}" alt="" style="height:40px;" ></a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-lg-3 col-6">
                    <div class="header-right-side text-end">
                        ...
                        @else
                            <a href="s" data-bs-toggle="modal" data-bs-target="#authModal">
                                <i class="icon-user"></i>
                            </a>
                        @endif
                        </div>
