function getDataByWindowUrlKey(){
    ...
    let url =  baseUrl+'/api/flower/'+windowUrlKey;
    ...
    .then(function (response) {
        ...
        $('#product-jenis_bunga').html(response.data.jenis_bunga);
        $('#product-florist').html('First florist '+response.data.florist+' by '+response.data.florist);
...
// tag
let collectionOfTag = ['Tulip', 'Best Seller', 'Mawar', 'Edelweis', 'Anggrek', 'Allamanda', 'Lily', 'Matahari', 'Kembang sepatu', 'Angelonia', 'Alyssum','Amarilis', 'Anemone', 'Ruellia', 'Askaia', 'Ammi', 'Anthurium'];
